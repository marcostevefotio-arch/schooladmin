...
@section('content')
    <div class="row">
        <div class="col-xs-12">
            <div class="clearfix">
                <div class="btn-group">
                    <a href="{{ route("enseignantDisciplineForm") }}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i>&nbsp;Enregistrer une absence</a>
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    ...
                    @foreach($discipline as $i=>$d)
                        <tr>
                            ...
                            <td>{{ date("d/m/Y", strtotime($d->journee)) }}</td>
                            <td>{{ $d->absence }}</td>
                            <td>{{ $d->motif }}</td>
                            <td> <i class="fa {{ $d->justifie? "fa-check text-success" : "fa-close text-danger" }}"></i></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
