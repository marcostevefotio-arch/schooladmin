    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="clearfix">
                ...
                <div class="btn-group">
                    <a href="{{ route("scolariteCreate") }}" class="btn btn-info btn-sm"><i class="fa fa-graduation-cap"></i>&nbsp;Nouveau verssement</a>
                    ...
                    <tbody>
                        @foreach($etudiants as $et)
                            <tr>
                                ...
                                <td>{{ $d->matricule }}</td>
                                <td>{{ $d->etudiant->lastname }} {{ $d->etudiant->lastname }}</td>
                                <td>{{ $d->frais }}</td>
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="red" href="{{ route("scolariteDelete", ["slug"=>$d->id]) }}">
                                    ...
                                    <div class="hidden-md hidden-lg">
                                        <div class="inline pos-rel">
                                            ...
                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                <li>
                                                    <a href="{{ route("scolariteDelete", ["slug"=>$d->id]) }}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                            <span class="red">
