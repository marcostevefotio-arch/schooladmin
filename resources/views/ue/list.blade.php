    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="clearfix">
                ...
                <div class="btn-group">
                    <a href="{{ route("ueForm") }}" class="btn btn-info btn-sm"><i class="fa fa-graduation-cap"></i>&nbsp;Nouvelle UE</a>
                    ...
                    <tbody>
                        @foreach($ue as $d)
                            <tr>
                                ...
                                <td>{{ $d->codeUE }}</td>
                                <td>{{ $d->libelleUE }}</td>
                                <td>{{ isset($d->specialite)? $d->specialite->libelleSpecialite : "" }}</td>
                                <td>{{ count($d->matiere) }}</td>
                                <td>{{ $d->total }}</td>
                                <td>{{ $d->credit }}</td>
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="green" href="{{ route("ueEdit", ["slug"=>$d->id]) }}">
                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                        </a>

                                        <a class="red" href="{{ route("ueDelete", ["slug"=>$d->id]) }}">
                                    ...
                                    <div class="hidden-md hidden-lg">
                                        <div class="inline pos-rel">
                                            ...
                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                <li>
                                                    <a href="{{ route("ueEdit", ["slug"=>$d->id]) }}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                        <span class="green">
                                                ...
                                                <li>
                                                    <a href="{{ route("ueDelete", ["slug"=>$d->id]) }}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                        <span class="red">
