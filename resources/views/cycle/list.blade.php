    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="clearfix">
                <br>
                <div class="btn-group">
                    <a href="{{ route("cycleCreate") }}" class="btn btn-info btn-sm"><i class="fa fa-graduation-cap"></i>&nbsp;Nouveau Cycle</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="green" href="{{ route("cycleEdit", ["slug"=>$d->id]) }}">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content modal-sm">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="{{ route("cycleDelete", ["slug"=>$d->id]) }}" class="btn btn-primary float-left"><i class="fa fa-check"></i>&nbsp;Oui</a>
                                    ...
                                    <div class="hidden-md hidden-lg">
                                        <div class="inline pos-rel">
                                            ...
                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                <li>
                                                    <a href="{{ route("cycleEdit", ["slug"=>$d->id]) }}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                        <span class="green">
