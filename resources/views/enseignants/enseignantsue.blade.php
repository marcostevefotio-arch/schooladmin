...
@section('content')
    <div class="row">
        <div class="col-xs-12">
            <div class="clearfix">
                <div class="btn-group">
                    <a href="{{ route("emForm") }}" class="btn btn-info btn-sm">Attribuer une ue</a>
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    ...
                    @foreach($enseignant as $d)
                        <tr>
                            ...
                            <td>
                                @foreach($d->enseignantMatiere  as $em)
                                    <a href="{{ route("matiereShow", ["slug"=>$em->id]) }}"><i title="{{ $em->matiere->libelleMatiere }}">{{ $em->matiere->codeMatiere }}</i></a>,&nbsp;
                                @endforeach
                            </td>
                            <th>
