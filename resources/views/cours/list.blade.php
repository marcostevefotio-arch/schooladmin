        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="clearfix">
                    ...
                    <div class="btn-group">
                        <a href="{{ route("newCours") }}"  class="btn btn-primary btn-sm"><i class="fa fa-bookmark"></i>&nbsp;Nouveau cours</a>
                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        ...
                        @foreach($cours as $d)
                            <tr>
                                ...
                                <td>{{ $d->enseignant->lastname }} {{ $d->enseignant->firstname }}</td>
                                <td>{{ $d->matiere->codeMatiere }} - {{ $d->matiere->libelleMatiere }}</td>
                                <td>{{ $d->debutCours }}</td>
                                <td>{{ $d->dureeCours }}</td>
                                <th>
                                    <div class="hidden-sm hidden-xs action-buttons">

                                        <a class="red" href="{{ route("coursDelete", ["slug"=>$d->id]) }}">
                                    ...
                                    <div class="hidden-md hidden-lg">
                                        <div class="inline pos-rel">
                                            ...
                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                ...
                                                <li>
                                                    <a href="{{ route("coursDelete", ["slug"=>$d->id]) }}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                            <span class="red">
