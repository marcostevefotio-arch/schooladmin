...
@section('breadcrum')
    ...
    <li><i class="ace-icon fa fa-hand-o-up  home-icon"></i><a href="{{ route("service") }}">Service</a></li>
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method="post" action="#">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Nom du service *</label>

                        <div class="col-sm-9">
                            <input type="text" id="form-field-1-1" placeholder="Nom du service" name="nom" class="form-control" required/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Debut et fin *</label>

                        <div class="col-sm-9">
                            <span class="input-icon">
                                <input type="time" id="form-field-icon-1" />
                                <i class="ace-icon fa fa-clock-o blue"></i>
                            </span>

                            <span class="input-icon input-icon-right">
                                <input type="time" id="form-field-icon-2" />
                                <i class="ace-icon fa fa-clock-o blue"></i>
                            </span>
                        </div>
                    </div>
