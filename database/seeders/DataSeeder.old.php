    ...
    public function menus(){
        ...
        $data_sub = array(
            ...
            array(
                ...
                array("code_menu"=>Str::lower("scolarite-configuration"), "menu_id"=>5, "libelle_menu"=>"Configuration", "icon_menu"=>"fa-cog", "slug"=>Str::slug(date("sihdmYmdhisu").Str::random(10)), "is_link"=>true)
            ),
            array(
            ...
            array(
                ...
                array("code_menu"=>Str::lower("organisation-parametre"), "menu_id"=>9, "libelle_menu"=>"Parametres d'application", "icon_menu"=>"fa-cogs", "slug"=>Str::slug(date("sihdmYmdhisu").Str::random(10)), "is_link"=>true)
            ),
            array(
    ...
    public function user(){
        ...
        $data = [
            [
                ...
                "personnel_id" => 1,
                "email"=>"admin@issat-cameroun.net",
                "active"=>1,
