...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="clearfix">
                <div class="btn-group">
                    <a href="{{ route("regionCreate") }}" class="btn btn-info btn-sm">&nbsp;Enregistrer une région</a>
            ...
            <div>
                @if($data->count()>0)
                    ...
                    <div class="table-header">
                        <span class="h2"><i class="fa fa-flag"></i>&nbsp;({{ $p->codePays }}, {{ $p->indicatifPays }}) {{ $p->nomPays }}</span>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="green" href="{{ route("regionEdit", ["slug"=>$d->id]) }}">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content modal-sm">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="{{ route("regionDelete", ["slug"=>$d->id]) }}" class="btn btn-primary float-left"><i class="fa fa-check"></i>&nbsp;Oui</a>
                                    ...
                                    <div class="hidden-md hidden-lg">
                                        <div class="inline pos-rel">
                                            ...
                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                <li>
                                                    <a href="{{ route("regionEdit", ["slug"=>$d->id]) }}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                            <span class="green">
                ...
                @else
                    <div class="table-header">
                        <span><i class="fa fa-flag"></i>&nbsp;Liste des régions</span>
                    </div>
