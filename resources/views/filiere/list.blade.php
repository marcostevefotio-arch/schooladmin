    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="clearfix">
                ...
                <div class="btn-group">
                    <a href="{{ route("filiereForm") }}" class="btn btn-info btn-sm"><i class="fa fa-graduation-cap"></i>&nbsp;Nouvelle Filiere</a>
                    ...
                    <tbody>
                        @foreach($data as $d)
                            <tr>
                                ...
                                <td>{{ $d->descriptionFiliere }}</td>
                                <td>{{ count($d->specialites) }}</td>
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="green" href="{{ route("filiereEdit", ["slug"=>$d->id]) }}">
                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                        </a>

                                        <a class="red" href="{{ route("filiereDelete", ["slug"=>$d->id]) }}">
                                    ...
                                    <div class="hidden-md hidden-lg">
                                        <div class="inline pos-rel">
                                            ...
                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                <li>
                                                    <a href="{{ route("filiereEdit", ["slug"=>$d->id]) }}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                        <span class="green">
                                                ...
                                                <li>
                                                    <a href="{{ route("filiereDelete", ["slug"=>$d->id]) }}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                        <span class="red">
