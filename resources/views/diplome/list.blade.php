...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="clearfix">
                <div class="btn-group">
                    <a href="{{ route("diplomeCreate") }}" class="btn btn-info btn-sm">&nbsp;Enregistrer un diplome</a>
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    ...
                    @foreach($data as $d)
                        <tr>
                            ...
                            <td>{{ $d->codeDiplomes }}</td>
                            <td>{{ $d->intuleDiplome }}</td>
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a class="green" href="{{ route("diplomeEdit", ["slug"=>$d->id]) }}">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content modal-sm">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="{{ route("diplomeDelete", ["slug"=>$d->id]) }}" class="btn btn-primary float-left"><i class="fa fa-check"></i>&nbsp;Oui</a>
                                ...
                                <div class="hidden-md hidden-lg">
                                    <div class="inline pos-rel">
                                        ...
                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                            <li>
                                                <a href="{{ route("diplomeEdit", ["slug"=>$d->id]) }}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                        <span class="green">
