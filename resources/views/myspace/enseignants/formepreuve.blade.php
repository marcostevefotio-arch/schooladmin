...
@section('breadcrum')
    ...
    <li><a href="{{ route("tevaluation", ["slug"=>auth()->user()->id]) }}">Evaluations</a></li>
    <li class="active">Creation d'une épreuve</li>
@endsection
                                ...
                                <div class="panel-body">
                                    <form action="{{ route("storeEvaluation") }}" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="file-control" name="fichier" id="fichier">
                                        </div>
                                        <div class="form-group">
