...
class EvaluationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("noteevaluation.notes");
    }
    ...
    public function create()
    {
        ...
        $data = array("semestre"=>$semestre,"filiere"=>$filieres, "matiere"=>$matiere, "classe"=>$classe);
    ...
    public function right(){
        ...
        $right = array();
        foreach ($user as $r){
            if($r->menu->code_menu=="note-evaluation" && !in_array($r->titre_permission, $right)){
