                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-lg-6 col-xs-12">
                            <div id="clockContaine" class="" onload="showTime()">
                        ...
                        <div class="col-lg-6 col-xs-12">
                            <div class="text-right">
                                <div class="btn-group float-right">
                                    <a href="{{ route("epreuve") }}" class="btn btn-primary" title="Nouvelle épreuve"><i class="fa fa-file-text">&nbsp;Creer une epreuve</i></a>
                                    <a href="{{ route("makeEvaluation") }}" class="btn btn-info" title="Nouvelle évaluation"><i class="fa fa-clock-o">&nbsp;Creer une Evaluation</i></a>
                                    <a href="{{ route("bulletinModel") }}" class="btn btn-info" title="Nouvelle évaluation"><i class="fa fa-clock-o">&nbsp;model bulletin</i></a>
                                </div>
                            </div>
                        </div>
