...
@section('breadcrum')
    ...
    <li><i class="ace-icon fa fa-bed  home-icon"></i><a href="{{ route("espace") }}">Chambres/Espaces</a></li>
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">Gestion des chambres/espaces</h3>
                        <div class="text-right">
                            <div class="btn-group float-right">
                                <a href="{{ route("espaceCreate") }}" class="btn btn-primary" title="Nouvel espace"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
