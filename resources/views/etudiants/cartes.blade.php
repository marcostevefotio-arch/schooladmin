...
@section('content')
    <div class="row">
        <div class="col-xs-12">
            <form action="{{ route("etudiant-carte-print") }}" method="post" target="_blank">
                {{ csrf_field() }}
                ...
                <h4><button type="submit" id="submit" class="btn btn-black"><i class="fa fa-print">&nbsp;Generer les Relevés de notes</i></button  ></h4>
            </form>
        </div>
    </div>
@endsection
